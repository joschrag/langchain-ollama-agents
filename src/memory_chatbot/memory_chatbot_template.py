...
history = ConversationBufferMemory(human_prefix=human)
history.chat_memory.add_ai_message("""Hello! What joke would you like to hear?""")
...
if __name__ == "__main__":
    while True:
        theme = input("\nYour theme: ")
        language = input("\nYour language: ")
        prompt = f"Tell me a single joke about {theme}. Also translate it to {language}."
